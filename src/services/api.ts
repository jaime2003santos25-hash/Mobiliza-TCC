 ...
 * O IP abaixo (192.168.15.2) é o IP atual do seu computador na sua rede Wi-Fi.
 * Certifique-se de que o computador e o celular estejam na MESMA REDE.
 */
 const BASE_URL = 'http://192.168.15.2:8080/api/';
...
const api = axios.create({
  ...
  timeout: 30000, // Aumentado para 30 segundos para dar tempo ao envio de e-mail
});
